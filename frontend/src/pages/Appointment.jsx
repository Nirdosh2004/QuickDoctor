...
const Appointment = () => {
  ...
  return docInfo && (
    <div>
      {/* Doctor details -------------------------------   */}
      <div className='flex flex-col font-medium gap-4 sm:flex-row'>
        <div>
        ...
        <div className='flex-1 border-2 border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
          ...
          <div className='flex font-medium items-center gap-2 text-sm mt-1 text-gray-700'>
            <p>{docInfo.degree} - {docInfo.speciality}</p>
            <button className='py-0.5 px-2 cursor-default border border-green-400 text-xs rounded-full'>{docInfo.experience}</button>
          </div>
          {/* doctor about */}
          <div className='mt-5'>
            <p className='flex  items-center gap-1 text-xs font-medium text-gray-900 mt-3'>About <img src={assets.info_icon} alt="" /> </p>
            <p className='text-sm  text-gray-700 max-w-[700px] mt-2'>{docInfo.about}</p>
          </div>
          <p className='text-gray-700 font-medium mt-4 flex gap-4 '>
            Appointment Fee: <span className='text-green-800'>{currencySymbol}{docInfo.fees}</span>
          </p>
        </div>
      </div>
